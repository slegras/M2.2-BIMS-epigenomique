...
2. select a job profile: "M2.2 BIMS épigénomique" and click on "Start"
![alt text][jupebai]
...
```{bash eval=FALSE}
cp -r /shared/projects/form_2022_24/M2.2-BIMS-epigenomique/data .
```
...
## Use genome file: /shared/projects/<your_project>/M2.2-BIMS-epigenomique/data/Escherichia_coli_K12.fasta.gz
...
3. Let's see the parameters of bowtie before launching the mapping:
  ...
  * Output file will be SRR576933.sam for the first replicate
...
## Output file : SRR576933.bam for SRR576933
...
1. Repeat the steps above (3 -> 6 - Mapping) for the files SRR576934.fastq.gz and SRR576938.fastq.gz in the directory named "**bam**" within the directory 02-Mapping.
...
# Run picard
## Output file: Marked_SRR576933.bam for SRR576933
...
module add samtools/1.10
## run samtools flagstat on Marked_SRR576933.bam
...
```{bash eval=FALSE}
cp /shared/projects/form_2022_24/M2.2-BIMS-epigenomique/03-ChIPQualityControls/fingerprint.png .
```
