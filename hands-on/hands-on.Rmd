...
7. Go to the directory /shared/projects/2321_m22_bims/<userid>/1-QualityControl in the tree directory on the left of the jupyterhub window and double click on FNR_IP_ChIP-seq_Anaerobic_A_fastqc.html to visualize the file.
![alt text][fastqc]
...
```{bash eval=FALSE}
module unload samtools/1.15.1 bowtie/1.3.1
```
...
module unload samtools/1.15.1 picard/2.23.5
...
6. Download the three bigwig files you have just generated
  ...
  * 04-Visualization/Anaerobic_INPUT_DNA.bw
...
bedtools getfasta \
  -fi ../data/Escherichia_coli_K12.fasta \
  -bed FNR_Anaerobic_A_summits+-100.bed \
